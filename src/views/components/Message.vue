  ...
  <el-card shadow="never">
    <template #header>
      <div class="card-header">
        <span class="font-medium"> 二次封装Message提示 </span>
      </div>
    </template>
    ...
    <el-space wrap>
      ...
      <el-button
        type="success"
        @click="
          message('Success类型消息', { type: 'success' })
        "
      >
        Success
      </el-button>
      <el-button
        type="warning"
        @click="
          message('Warning类型消息', { type: 'warning' })
        "
      >
        Warning
      </el-button>
      ...
      <el-button
        @click="message('可关闭消息', { showClose: true })"
      >
        可关闭
      </el-button>
      <el-button
